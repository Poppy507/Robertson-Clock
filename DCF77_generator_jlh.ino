...
//  This version modified by John Haine August/October 2022 to:
//   (a) Output pulses at 1Hz rate encoding the DCF77 signal rather than modulated carrier
//   (b) Make the LED_BUILTIN pin an output for these pulses
//   (c) Disable the carrier output on pin 3.
//  Thanks to Udo Klein for guidance. 
...
void setup() {
    ...
    Serial.println(F("output on pin D13"));
